...
[CustomEditor(typeof(DialogTreeAsset))]
public class DialogTreeAssetEditor : Editor
{
    MyTreeView m_TreeView;
    SearchField m_SearchField;
    const string kSessionStateKeyPrefix = "TVS";

    DialogTreeAsset asset
    {
        get { return (DialogTreeAsset)target; }
    }
    ...
    class MyTreeView : TreeViewWithTreeModel<DialogTreeElement>
    {
        public MyTreeView(TreeViewState state, TreeModel<DialogTreeElement> model)
            : base(state, model)
        {
            showBorder = true;
